...
- `test_ams_commands_address_ams_lite_on_a2l` (`tests/integration/client_negative_test.rs`) covers every public `ams_id`-taking client entry point — add any new one to it.
