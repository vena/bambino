...
*   **Network Transport Layer & Device Discovery** ([`01_network_discovery.md`](01_network_discovery.md)): Defines the SSDP service structures, multicast socket configurations, direct TCP/UDP port mapping boundaries, and local TLS negotiation requirements.
*   **Secure FTP File & Storage System** ([`02_ftps.md`](02_ftps.md)): Establishes the implicit FTPS session handshake, command/data channel encryption management, local file/directory path boundaries, and transactional packet verification steps.
*   **Local Broker Control & State Telemetry** ([`03_mqtt_telemetry.md`](03_mqtt_telemetry.md)): Codifies the authenticated local broker topologies, direct command-to-report structures, and transactional print job lifecycle tracking.
*   **Toolhead, Thermal, Motion & Climate Systems** ([`04_toolhead_thermal_motion.md`](04_toolhead_thermal_motion.md)): Specifies the actual vs. target packed temperature formats, fan PWM scaling, and kinematic relative/absolute coordinates.
*   **Physical Material Expansion (AMS, AMS-HT & Spools)** ([`05_materials_ams.md`](05_materials_ams.md)): Details the expansion bus bitmask maps, moisture evaluation profiles, RFID serialization, and active dry-chamber configurations.
*   **Video Streaming & Chamber Image Handshakes** ([`06_cameras.md`](06_cameras.md)): Documents the dual video/imaging interfaces, direct RTSPS handshakes, and proprietary binary chamber image streams.
*   **Diagnostic Mapping & Calibration Profiles** ([`07_diagnostics_hms.md`](07_diagnostics_hms.md)): Formulates the raw HMS code translation algorithms, error level parsing, and linear pressure-advance (K-profile) database storage.
...
### [Chapter 1: Network Transport Layer & Device Discovery](01_network_discovery.md)
...
*   **[REF-NET-SECURE] Section 1.3: Cryptographic Context & Handshakes**
    ...
    *   Where handshake time actually goes (measured), why session resumption does not work with these printers, and the ESP32 build setting that saves ~230 ms per handshake by picking a curve the chip can accelerate
...
### [Chapter 2: Secure FTP File & Storage System](02_ftps.md)
...
### [Chapter 3: Local Broker Control & State Telemetry](03_mqtt_telemetry.md)
...
### [Chapter 4: Toolhead, Thermal, Motion & Climate Systems](04_toolhead_thermal_motion.md)
...
### [Chapter 5: Physical Material Expansion (AMS, AMS-HT & Spools)](05_materials_ams.md)
...
### [Chapter 6: Video Streaming & Chamber Image Handshakes](06_cameras.md)
...
### [Chapter 7: Diagnostic Mapping & Calibration Profiles](07_diagnostics_hms.md)
