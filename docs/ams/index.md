...
- **`ams_id`**: `u8`
  ...
  [`AmsEntryKind`](mapping/index.md#amsentrykind) warns about, since a caller reading this field in isolation could add
  defensive rejection that breaks A2L support (issue #221). Classify with
  [`classify_mapping2_entry`](mapping/index.md#classify-mapping2-entry) rather than re-deriving the ranges.
