...
- <span id="projectfilerequest-from-config"></span>`fn from_config(config: &PrintJobConfig, sequence_id: u64, model: BambuModel) -> Self` — [`PrintJobConfig`](#printjobconfig), [`BambuModel`](../../../models/index.md#bambumodel)
